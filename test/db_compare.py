...
def compare():
    ...
    for system_id in [1] + list(range(4,20)):
        sql_string_old = \
        ...
        pv_system = solarlog_parse.js_basevars(f"/home/hbl/u/comp/hint/fs/web/monitoring/anlagen/{'%02d' % system_id}/base_vars.js", system_id)
