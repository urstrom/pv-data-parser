...
def db_import_from_pickle(id, date_begin, date_end):
   pv_data.date_range(f"{config.path_data_pickled}{id:02}", date_begin, date_end, pv_data.unpickle,
        [filter.production, filter.deduplicate_zeros], output_db.db_check, id=id)
